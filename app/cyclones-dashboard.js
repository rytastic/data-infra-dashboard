...
/**
 * cyclones-dashboard theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { cyclonesDashboardTheme } from './cyclones-dashboard';
 *   import './cyclones-dashboard.css';
 */
export const cyclonesDashboardTheme = {
  ...
  tokens: {
    ...
    "--radius-page": "1.75rem",
    "--radius-full": "9999px",
    "--shadow-low": "0px 1px 2px light-dark(rgba(0,0,0,0.04), rgba(0,0,0,0.12)), 0px 1px 4px light-dark(rgba(0,0,0,0.06), rgba(0,0,0,0.18))",
    "--shadow-med": "0px 1px 2px light-dark(rgba(0,0,0,0.05), rgba(0,0,0,0.14)), 0px 3px 8px light-dark(rgba(0,0,0,0.07), rgba(0,0,0,0.20))",
    "--shadow-high": "0px 2px 4px light-dark(rgba(0,0,0,0.06), rgba(0,0,0,0.16)), 0px 6px 18px light-dark(rgba(0,0,0,0.10), rgba(0,0,0,0.26))",
